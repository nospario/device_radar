...
- **`think=False`** — all structured-output LLM calls (extraction, synthesis, categorisation) use `think=False` to prevent qwen3's thinking mode from consuming the output token budget.
